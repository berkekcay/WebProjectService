...
public interface ISubscriptionService
{
    ...
    Task<IReadOnlyCollection<WebProjectService.Dtos.Subscriptions.MemberSubscriptionResponse>> GetMemberSubscriptionsAsync(int memberId, CancellationToken cancellationToken);
